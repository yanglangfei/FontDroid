...
public class Switch extends android.widget.Switch implements IFont {
    ...
    public Switch(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        getStyleable(context, attributeSet, 0, 0);
    }

    public Switch(final Context context, final AttributeSet attributeSet, final int defStyleAttr) {
    ...
    public Switch(final Context context, final AttributeSet attributeSet, final int defStyleAttr, final int defStyleRes) {
