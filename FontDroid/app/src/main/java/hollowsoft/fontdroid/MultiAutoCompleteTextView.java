 ...
 * @author Igor Morais
 */
public class MultiAutoCompleteTextView extends android.widget.MultiAutoCompleteTextView implements IFont {

    public MultiAutoCompleteTextView(final Context context) {
        super(context);
    }

    public MultiAutoCompleteTextView(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        getStyleable(context, attributeSet, 0, 0);
    }

    public MultiAutoCompleteTextView(final Context context, final AttributeSet attributeSet, final int defStyleAttr) {
    ...
    public MultiAutoCompleteTextView(final Context context, final AttributeSet attributeSet, final int defStyleAttr, final int defStyleRes) {
