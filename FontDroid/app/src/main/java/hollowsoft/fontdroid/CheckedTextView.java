...
public class CheckedTextView extends android.widget.CheckedTextView implements IFont {

    public CheckedTextView(final Context context) {
        super(context);
    }

    public CheckedTextView(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        getStyleable(context, attributeSet, 0, 0);
    }

    public CheckedTextView(final Context context, final AttributeSet attributeSet, final int defStyleAttr) {
    ...
    public CheckedTextView(final Context context, final AttributeSet attributeSet, final int defStyleAttr, final int defStyleRes) {
