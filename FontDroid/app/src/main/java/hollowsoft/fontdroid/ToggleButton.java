...
public class ToggleButton extends android.widget.ToggleButton implements IFont {

    public ToggleButton(final Context context) {
        super(context);
    }

    public ToggleButton(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        getStyleable(context, attributeSet, 0, 0);
    }

    public ToggleButton(final Context context, final AttributeSet attributeSet, final int defStyleAttr) {
    ...
    public ToggleButton(final Context context, final AttributeSet attributeSet, final int defStyleAttr, final int defStyleRes) {
