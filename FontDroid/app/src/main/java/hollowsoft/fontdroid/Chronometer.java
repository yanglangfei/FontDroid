...
public class Chronometer extends android.widget.Chronometer implements IFont {

    public Chronometer(final Context context) {
        super(context);
    }

    public Chronometer(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        getStyleable(context, attributeSet, 0, 0);
    }

    public Chronometer(final Context context, final AttributeSet attributeSet, final int defStyleAttr) {
    ...
    public Chronometer(final Context context, final AttributeSet attributeSet, final int defStyleAttr, final int defStyleRes) {
