...
public class RadioButton extends android.widget.RadioButton implements IFont {
    ...
    public RadioButton(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        getStyleable(context, attributeSet, 0, 0);
    }

    public RadioButton(final Context context, final AttributeSet attributeSet, final int defStyleAttr) {
    ...
    public RadioButton(final Context context, final AttributeSet attributeSet, final int defStyleAttr, final int defStyleRes) {
