 ...
 * @author Igor Morais
 */
public class CheckBox extends android.widget.CheckBox implements IFont {

    public CheckBox(final Context context) {
        super(context);
    }

    public CheckBox(final Context context, AttributeSet attributeSet) {
        super(context, attributeSet);

        getStyleable(context, attributeSet, 0, 0);
    }

    public CheckBox(final Context context, final AttributeSet attributeSet, final int defStyleAttr) {
    ...
    public CheckBox(final Context context, final AttributeSet attributeSet, final int defStyleAttr, final int defStyleRes) {
