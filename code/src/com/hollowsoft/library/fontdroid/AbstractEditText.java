 ...
 */
public abstract class AbstractEditText extends android.widget.EditText {

    /**
     *
     * @param context
     */
    public AbstractEditText(final Context context) {
        super(context);
    }
     ...
     * @param attributeSet
     */
    public AbstractEditText(final Context context, final AttributeSet attributeSet) {
     ...
     * @param defStyle
     */
    public AbstractEditText(final Context context, final AttributeSet attributeSet, final int defStyle) {
